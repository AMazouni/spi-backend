...
public class Promotion implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return nbMaxEtudiant == that.nbMaxEtudiant && Objects.equals(codeFormation, that.codeFormation)
				...
				&& Objects.equals(dateRentree, that.dateRentree) && Objects.equals(lieuRentree, that.lieuRentree)
				&& Objects.equals(processusStage, that.processusStage) && Objects.equals(commentaire, that.commentaire);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeFormation, anneeUniversitaire, noEnseignant, siglePromotion, nbMaxEtudiant,
				dateReponseLp, dateReponseLalp, dateRentree, lieuRentree, processusStage, commentaire);
	}
